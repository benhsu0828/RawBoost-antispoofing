...
if __name__ == '__main__':
    ...
    parser.add_argument('--protocols_path', type=str, default='C:/Users/bente/Desktop/dataset/forRawNet2/protocols_path/', help='Change with path to user\'s LA database protocols directory address')
    '''
    % protocols_path/
